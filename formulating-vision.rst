...
Your description --- the picture you paint --- will need to include an overarching ambition, that includes particular objectives, and an account of how you plan to reach them all.
...
It's not the place to go into the finer details though. We don't set out *how* each of these will be judged, nor are they set in a time frame. But, questions about these statements should follow naturally from them, and you will need at different times to have clear answers.
